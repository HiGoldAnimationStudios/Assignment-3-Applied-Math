function global_trunc_error(rate_func_in, X, t_0, t_f)
    ...
    for i = 1:length(h_values)
        ...
        while t_current < t_f
            ...
            x_current_ex_mid = explicit_midpoint_step(rate_func_in, t_current, x_current_ex_mid, h_step);
            x_current_bw_e = backward_euler_step(rate_func_in,t_current,x_current_bw_e, h_step);
            x_current_im_mid = implicit_midpoint_step(rate_func_in, t_current, x_current_im_mid, h_step);
